		...
		<div id="list-secUser" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="homepage" title="${message(code: 'secUser.homepage.label', default: 'Homepage')}" />
					
						<th><g:message code="secUser.profile.label" default="Profile" /></th>
				...
				<g:each in="${secUserInstanceList}" status="i" var="secUserInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: secUserInstance, field: "homepage")}</td>
					
						<td>${fieldValue(bean: secUserInstance, field: "profile")}</td>
