...
<html>
	...
	<body>
		...
		%{--signup Button--}%
			<g:form url="[resource:secUserInstance, action:'signUp']" >
				<fieldset class="form">
					<g:render template="form"/>
				</fieldset>
				<fieldset class="buttons">
					<g:submitButton name="signUp" class="signUp" value="${message(code: 'default.button.create.label', default: 'SignUp')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
